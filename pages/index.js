  ...
  return (
    <>
      <div className={styles.cover}>
        <h1 className={styles.myname}>Hi my Name is, </h1>
      ...
      <div className={styles.positionsection}>
        ...
        <p className={styles.aboutme}>
          ...
          Computer Programming and Analysis from Seneca College, and hands-on
          experience as a Low Code Application Developer. My career path
          reflects a strong blend of technical expertise, problem-solving
          ability, and leadership, particularly in public sector environments.
        </p>
        <div className={styles.theheader}>
          {" "}
      ...
      <div className={styles.positionhero}>
        ...
        <ol className={styles.ol}>
          <li >
            ...
            required manual intervention,<br></br> leading to significant time savings.
          </li>
          <li>
            Collaborated with the UI/UX team to redesign and enhance multiple
            web interfaces, focusing on accessibility, <br></br> usability, and visual
            appeal, resulting in improved user satisfaction.
          </li>
          <li>
            Utilized WAVE and Lighthouse testing tools to ensure that
            applications met accessibility standards, <br></br>particularly in areas like
          ...
          <li>
            ...
            solutions into larger enterprise systems, which <br></br> helped modernize
